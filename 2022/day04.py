...
def solve(data):
  ...
  fully_contained = [assignment_pair for assignment_pair in assignments if fully_contains(assignment_pair)]

  p1 = len(fully_contained)
  assert p1 == 528

  overlapping = [assignment_pair for assignment_pair in assignments if overlaps(assignment_pair)]
